...
public class ShipmentCreated extends DomainEvent {
    ...
    public ShipmentCreated(SellerID sellerID, AddresseeID addresseeID, DomiciliaryID domiciliaryID, Address address, ShippingDescription shippingDescription, Date date) {
