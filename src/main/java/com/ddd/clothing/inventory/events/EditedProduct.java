...
public class EditedProduct extends DomainEvent {
    ...
    public EditedProduct(ProductID productID, InventoryName inventoryName, ProductDescription productDescription, PriceProduct priceProduct) {
        super("clothing.inventory.EditedProduct");
